...
public class NetworkManager : MonoBehaviour, INetworkRunnerCallbacks
{
    ...
    public SessionsListDataSO SessionsListData;
    
    public ReadyManager readyManagerInstance;
    private string _currentLobbyId;
    
    public event Action<List<SessionInfo>, int> OnSessionDataRefreshed;
    ...
    public async void ConnectToCustomLobby(string targetLobbyId)
    {
        _currentLobbyId = targetLobbyId;
        await networkRunnerInstance.JoinSessionLobby(SessionLobby.Custom, _currentLobbyId);
    }
    
    public async void CreateRoomInCurrentLobby(string roomName, int maxPlayers)
    {
    ...
    public void OnSessionListUpdated(NetworkRunner runner, List<SessionInfo> sessionList)
    {
        ...
        OnSessionDataRefreshed?.Invoke(validRooms, totalPlayersInThisLobby);
    }
